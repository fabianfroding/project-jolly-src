...
public class EnemyStonetusk_PlayerDetectedState : PlayerDetectedState
{
    ...
    public EnemyStonetusk_PlayerDetectedState(EnemyPawn enemy, FiniteStateMachine stateMachine, int animBoolName, D_PlayerDetectedState stateData, EnemyStonetusk stonetusk) : base(enemy, stateMachine, animBoolName, stateData)
    {

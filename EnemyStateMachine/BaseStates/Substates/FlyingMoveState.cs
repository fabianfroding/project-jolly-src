public class FlyingMoveState : MoveState
{
    ...
    public FlyingMoveState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_MoveState stateData) : base(enemy, stateMachine, animBoolName, stateData)
    {}

...
public class EnemyGundyr_MeleeAttackSecondState : MeleeAttackState
{
    ...
    public EnemyGundyr_MeleeAttackSecondState(EnemyPawn enemy, FiniteStateMachine stateMachine, int animBoolName, GameObject meleeAttackDamageHitBox, D_MeleeAttackState stateData) : base(enemy, stateMachine, animBoolName, meleeAttackDamageHitBox, stateData)
    {

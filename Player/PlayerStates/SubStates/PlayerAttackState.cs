...
public class PlayerAttackState : PlayerAbilityState
{
    ...
    public PlayerAttackState(Player player, PlayerStateMachine stateMachine, Player_StateData playerStateData, string animBoolName) : base(player, stateMachine, playerStateData, animBoolName)
    {}

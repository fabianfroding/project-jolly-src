...
public class PlayerPickupPowerupState : PlayerLockedState
{
    ...
    public PlayerPickupPowerupState(Player player, PlayerStateMachine stateMachine, Player_StateData playerStateData, string animBoolName) : base(player, stateMachine, playerStateData, animBoolName)
    {}

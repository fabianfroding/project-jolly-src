public class EnemyDruid_ChargeState : ChargeState
{
    ...
    public EnemyDruid_ChargeState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_ChargeState stateData, EnemyDruid druid) : base(enemy, stateMachine, animBoolName, stateData)
    {
        this.druid = druid;
    }

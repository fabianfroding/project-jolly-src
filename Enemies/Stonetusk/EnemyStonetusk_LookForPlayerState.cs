public class EnemyStonetusk_LookForPlayerState : LookForPlayerState
{
    ...
    public EnemyStonetusk_LookForPlayerState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_LookForPlayerState stateData, EnemyStonetusk stonetusk) : base(enemy, stateMachine, animBoolName, stateData)
    {

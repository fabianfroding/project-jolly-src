public class EnemyStonetusk_ChargeState : ChargeState
{
    ...
    public EnemyStonetusk_ChargeState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_ChargeState stateData, EnemyStonetusk Stonetusk) : base(enemy, stateMachine, animBoolName, stateData)
    {

...
public class EnemyJungleBeast_JumpState : State
{
    ...
    private PlayerCharacter cachedPlayerCharacterTarget;
    ...
    public EnemyJungleBeast_JumpState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, JungleBeast_JumpStateData stateData)
    ...
    {
        base.Enter();
        cachedPlayerCharacterTarget = enemy.AIVision.TargetPlayerCharacter;
        isJumping = false;
    }
    ...
    public void Jump()
    {
        ...
        targetPosition = cachedPlayerCharacterTarget.transform.position;

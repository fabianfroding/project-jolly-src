public class EnemyPlaguetooth_StunState : StunState
{
    ...
    public EnemyPlaguetooth_StunState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_StunState stateData, EnemyPlaguetooth plaguetooth) : base(enemy, stateMachine, animBoolName, stateData)
    {

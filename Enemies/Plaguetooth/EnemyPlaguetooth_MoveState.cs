public class EnemyPlaguetooth_MoveState : MoveState
{
    ...
    public EnemyPlaguetooth_MoveState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_MoveState stateData, EnemyPlaguetooth plaguetooth)

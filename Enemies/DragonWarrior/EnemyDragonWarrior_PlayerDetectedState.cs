public class EnemyDragonWarrior_PlayerDetectedState : PlayerDetectedState
{
    ...
    public EnemyDragonWarrior_PlayerDetectedState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_PlayerDetectedState stateData) : base(enemy, stateMachine, animBoolName, stateData)
    {

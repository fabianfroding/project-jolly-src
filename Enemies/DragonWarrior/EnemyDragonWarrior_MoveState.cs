public class EnemyDragonWarrior_MoveState : MoveState
{
    ...
    public EnemyDragonWarrior_MoveState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_MoveState stateData) : base(enemy, stateMachine, animBoolName, stateData)
    {

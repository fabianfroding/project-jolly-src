...
public class EnemyDragonWarrior_FlyState : State
{
    ...
    public EnemyDragonWarrior_FlyState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, DragonWarrior_FlyStateData stateData) : base(enemy, stateMachine, animBoolName)
    {

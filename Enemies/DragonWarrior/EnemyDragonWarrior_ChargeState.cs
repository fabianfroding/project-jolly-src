public class EnemyDragonWarrior_ChargeState : ChargeState
{
    ...
    public EnemyDragonWarrior_ChargeState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_ChargeState stateData) : base(enemy, stateMachine, animBoolName, stateData)
    {

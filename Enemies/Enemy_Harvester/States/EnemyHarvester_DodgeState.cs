public class EnemyHarvester_DodgeState : DodgeState
{
    ...
    public EnemyHarvester_DodgeState(Enemy enemy, FiniteStateMachine stateMachine, string animBoolName, D_DodgeState stateData, EnemyHarvester harvester) : base(enemy, stateMachine, animBoolName, stateData)
    {

public class EnemyHarvester_StunState : StunState
{
    ...
    public EnemyHarvester_StunState(EnemyPawn enemy, FiniteStateMachine stateMachine, int animBoolName, D_StunState stateData, EnemyHarvester harvester) : base(enemy, stateMachine, animBoolName, stateData)
    {

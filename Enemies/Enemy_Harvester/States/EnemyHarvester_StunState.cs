public class EnemyHarvester_StunState : StunState
{
    ...
    public EnemyHarvester_StunState(Enemy enemy, FiniteStateMachine stateMachine, string animBoolName, D_StunState stateData, EnemyHarvester harvester) : base(enemy, stateMachine, animBoolName, stateData)
    {

...
public class EnemyHarvester_PlayerDetectedState : PlayerDetectedState
{
    ...
    public EnemyHarvester_PlayerDetectedState(Enemy enemy, FiniteStateMachine stateMachine, string animBoolName, D_PlayerDetectedState stateData, EnemyHarvester harvester) : base(enemy, stateMachine, animBoolName, stateData)
    {

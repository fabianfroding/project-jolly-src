...
public class EnemyHarvester_MoveState : MoveState
{
    ...
    public EnemyHarvester_MoveState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_MoveState stateData, EnemyHarvester harvester) : base(enemy, stateMachine, animBoolName, stateData)
    {

...
public class EnemyHarvester_PlayerDetectedState : PlayerDetectedState
{
    ...
    public EnemyHarvester_PlayerDetectedState(EnemyCharacter enemy, FiniteStateMachine stateMachine, int animBoolName, D_PlayerDetectedState stateData, EnemyHarvester harvester) : base(enemy, stateMachine, animBoolName, stateData)
    {

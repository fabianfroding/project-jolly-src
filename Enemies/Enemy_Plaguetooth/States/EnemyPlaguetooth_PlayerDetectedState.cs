public class EnemyPlaguetooth_PlayerDetectedState : PlayerDetectedState
{
    ...
    public EnemyPlaguetooth_PlayerDetectedState(Enemy enemy, FiniteStateMachine stateMachine, int animBoolName, D_PlayerDetectedState stateData, EnemyPlaguetooth plaguetooth) : base(enemy, stateMachine, animBoolName, stateData)
    {

public class EnemyPlaguetooth_MoveState : MoveState
{
    ...
    public EnemyPlaguetooth_MoveState(Enemy enemy, FiniteStateMachine stateMachine, string animBoolName, D_MoveState stateData, EnemyPlaguetooth plaguetooth) : base(enemy, stateMachine, animBoolName, stateData)
    {

...
public class EnemyPlaguetooth_MeleeAttackState : MeleeAttackState
{
    ...
    public EnemyPlaguetooth_MeleeAttackState(Enemy enemy, FiniteStateMachine stateMachine, string animBoolName, Transform attackPosition, D_MeleeAttackState stateData, EnemyPlaguetooth plaguetooth) : base(enemy, stateMachine, animBoolName, attackPosition, stateData)
    {

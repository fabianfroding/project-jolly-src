public class EnemyPlaguetooth_IdleState : IdleState
{
    ...
    public EnemyPlaguetooth_IdleState(EnemyPawn enemy, FiniteStateMachine stateMachine, int animBoolName, D_IdleState stateData, EnemyPlaguetooth plaguetooth) : base(enemy, stateMachine, animBoolName, stateData)
    {

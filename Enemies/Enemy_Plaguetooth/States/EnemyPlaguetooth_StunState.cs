public class EnemyPlaguetooth_StunState : StunState
{
    ...
    public EnemyPlaguetooth_StunState(Enemy enemy, FiniteStateMachine stateMachine, string animBoolName, D_StunState stateData, EnemyPlaguetooth plaguetooth) : base(enemy, stateMachine, animBoolName, stateData)
    {

...
public class Combat : CoreComponent
{
    ...
    [Tooltip("Check to allow the character to recieve stun damage.")]
    [SerializeField] protected bool stunnable = false;
    [Tooltip("The time-window in which a character can get stunned after it has become vulnerable to stun damage.")]
    [SerializeField] protected float stunTimeWindow = 2f;
    [Tooltip("The amount of hits/damage before the character can get stunned.")]
    ...
    [Tooltip("If the character can block, this is the state it will default to when blocking.")]
